...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      high_cls = this.form_field_jq.attr("class");
        ...
        if (data.group) {
          ...
          if (data.selected && this.is_multiple) {
            this.choice_build(data);
                 ...
                 if (high_cls == 'chzn-split-text'){
                    var substr_itemtext = item.text.split(' ');
                    this.selected_item.find("span").first().text(substr_itemtext[0]);
                }
                else{
